...
function ProjectVideo({ src, thumbnail }: ProjectVideoProps) {
  ...
  const isLoomVideo = src.includes('loom.com')
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex-1">
          <p className="text-zinc-600 dark:text-zinc-400">
            I love figuring out how things work under the hood and why they work the way they do.
            I'm always curious about the words "how" and "why." I enjoy solving problems in smart ways
            and learning from every little challenge — whether at work, at home, or even over coffee.
            <br />
            I'm curious about everything, fascinated by ideas that make life smoother,
            and excited to keep building cool things that make a real difference.
          </p>
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 md:grid-cols-2 gap-4 space-y-0">
          <AnimatedBackground
            enableHover
          ...
          >
            {BLOG_POSTS.map((post) => (
              ...
              >
                {
                  post.thumbnail && (
                    <div className="relative aspect-auto w-full cursor-zoom-in rounded-xl overflow-hidden">
                      <img
                        src={post.thumbnail}
                        alt={post.title}
                        height={200}
