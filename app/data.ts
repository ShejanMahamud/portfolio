...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    title: 'JavaScript Internals: Global Execution Context & Temporal Dead Zone',
    description: 'A deep dive into the mechanics of JavaScript’s execution context, hoisting and the temporal dead zone.',
    link: '/blog/javaScript-internals-global-execution-context-and-temporal-dead-zone',
    uid: 'blog-2',
    language: 'bn',
    thumbnail: '/blogs/js-internals.webp',
    tags: ["JavaScript", "Programming", "Web Development"],
