...
কখন ভেবে দেখেছেন, Javascript - এ সবকিছুই `Object` বা `Object`-এর মতো আচরণ করে কিন্তু কিভাবে করে? কিভাবে `inheritance` কাজ করে? `proto` আর `prototype` এর মধ্যে পার্থক্য কোথায়? এই প্রশ্নগুলো আমাদের সবার মনেই আসে, তাই আজকে আমরা এই বিষয়েগুলো নিয়েই আলোচনা করবো। আমরা উত্তর খুঁজব কি, কেন এবং কিভাবে।
